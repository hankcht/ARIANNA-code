...
def RunMultipleJobs(commandtorun, jobName='Batchjob', runDirectory='/pub/tangch3/ARIANNA/DeepLearning/', python_env='default'):
    ...
    header += "#SBATCH --time=1-00:00:00               ##Max runtime D-HH:MM:SS, 3 days free maximum\n"
...
if __name__ == "__main__":
    ...
    epochs = [1713, 2013, 2213, 3013] # 30, 50, 80, 100, 300, 500, 850, 1000, 1200, 1500, 1800, 2000
    seeds = []
    for epoch in epochs: 
        cmd = f"python /pub/tangch3/ARIANNA/DeepLearning/code/200s_time/HGQ_1D_CNN.py --epochs {epoch} --seed 69"
