...
def build_hgq_model(input_shape, ramp_epochs, beta0=1e-5, beta_final=1e-4):
    ...
    scope0 = QuantizerConfigScope(place='all', b0=32, i0=0, default_q_type='kbi', overflow_mode='SAT_SYM') # b0=3, k0=1,
    ...
    with scope0, scope1: 
        ...
        model = keras.Sequential([
                    ...
                    QConv1D(10, kernel_size=10, beta0=beta0, iq_conf=None, activation='relu', name='conv1d_1'),
                    # keras.layers.Dropout(0.5),
                    keras.layers.Flatten(),
                    QDense(1, beta0=beta0, activation='sigmoid', name='dense_0', oq_conf=None)
                ])
