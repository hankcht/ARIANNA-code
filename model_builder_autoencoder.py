...
def build_vae_model_freq(input_shape=(129, 4), learning_rate=0.001, latent_dim=128, kl_weight=0.5):
    """
...
def build_vae_bottleneck_model_freq(input_shape=(129, 4), learning_rate=0.001, latent_dim=64, kl_weight=0.5):
    """
...
def build_vae_denoising_model_freq(input_shape=(129, 4), learning_rate=0.001, latent_dim=64, kl_weight=0.5, noise_stddev=0.1):
    """
...
def build_vae_mae_loss_model_freq(input_shape=(129, 4), learning_rate=0.001, latent_dim=64, kl_weight=0.5, noise_stddev=0.1):
    """
