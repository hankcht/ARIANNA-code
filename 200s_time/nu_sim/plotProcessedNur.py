...
#plt.show()
plt.savefig(f'/pub/tangch3/ARIANNA/DeepLearning/true_therm_noise/StationDataAnalysis/plots/station{station_id}_NuRCR_Chi_dist.png')
plt.clf()
...
#plt.show()
plt.savefig(f'/pub/tangch3/ARIANNA/DeepLearning/true_therm_noise/StationDataAnalysis/plots/SNRplots/station{station_id}_SNR_distribution.png')
plt.clf()
...
#plt.show()
plt.savefig(f'/pub/tangch3/ARIANNA/DeepLearning/true_therm_noise/StationDataAnalysis/plots/SNRplots/station{station_id}_NuXcorr.png')
plt.clf()
...
#plt.show()
plt.savefig(f'/pub/tangch3/ARIANNA/DeepLearning/true_therm_noise/StationDataAnalysis/plots/SNRplots/station{station_id}_ReflCrXcorr.png')
plt.clf()
