...
if __name__ == "__main__":
    ...
    config.read('/pub/tangch3/ARIANNA/DeepLearning/code/200s_time/config.ini')
    date = config['PARAMETERS']['date']
    date_cuts = config['PARAMETERS']['date_cuts']
    date_processing = config['PARAMETERS']['date_processing']

    station_data_folder = f'/dfs8/sbarwick_lab/ariannaproject/rricesmi/HRAStationData/'
    cuts_data_folder = f'/dfs8/sbarwick_lab/ariannaproject/rricesmi/HRAStationData/cuts/'
    output_folder = f'/pub/tangch3/ARIANNA/DeepLearning/HRAStationDataAnalysis/ErrorAnalysis/output/{date_processing}/'
