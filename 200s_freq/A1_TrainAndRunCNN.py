...
def Train_CNN():
    ...
    y = np.vstack((np.ones((RCR_freq.shape[0], 1)), np.zeros((Backlobe_freq.shape[0], 1)))) 
...
model_path = f'/pub/tangch3/ARIANNA/DeepLearning/models/{amp}_freq/'                                  
accuracy_plot_path = f'/pub/tangch3/ARIANNA/DeepLearning/plots/Simulation/accuracy/{amp}_freq/' 
loss_plot_path = f'/pub/tangch3/ARIANNA/DeepLearning/plots/Simulation/loss/{amp}_freq/'         
...
################################################################################################
    ...
    ax.set_yscale('log')
    ax.set_title(f'{amp}_freq RCR-Backlobe network output')
